...
namespace Fortuneteller
{
    ...
    public class Ball : McCustomBase
    {
        ...
        public override void OnDraw(GeometryBuilder dc)
        {
            ...
            dc.TextHeight = 31;
            dc.DrawMText(_basePnt, Vector3d.XAxis, _text, HorizTextAlign.Center, VertTextAlign.Center, _radius / 2.05);
        ...
        public override bool GetGripPoints(GripPointsInfo info)
        {
            ...
            {
                items.Add(new ContextMenuItem("Shake Ball", "none", 1));
        ...
        private void ShakePredict()
        {
            ...
            int val = rand.Next(0, predictions.Count-1);
            this.TryModify();
            _text = predictions[val];
